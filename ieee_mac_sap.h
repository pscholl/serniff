...
/* This is a MODIFIED version with explicit padding and packing.
 */
...
typedef enum
{
    ...
    NUM_MAC_SAP
} __attribute((__packed__)) MAC_Sap_e;
/**
 * @ingroup g_mac_sap
...
} __attribute((__packed__)) MAC_Enum_e;
/**
 * @ingroup g_mac_sap_scan
...
} __attribute((__packed__)) MAC_MlmeScanType_e;
/**
...
} __attribute((__packed__)) MAC_TransmitOption_e;
/**
 * @ingroup g_mac_sap_pib
...
} __attribute((__packed__)) MAC_PibAttr_e;
/*
*******************************************************************
...
} __attribute((__packed__)) MAC_ExtAddr_s;
/**
 * @ingroup g_mac_sap_addr
...
} __attribute((__packed__)) MAC_Addr_u;
/**
 * @ingroup g_mac_sap_addr
 * @brief MAC Address
 *
...
} __attribute((__packed__)) MAC_Addr_s;
/**
 * @ingroup g_mac_sap_sec
...
} __attribute((__packed__)) MAC_SapAclEntry_s;
/**
 * @ingroup g_mac_sap_pib
 * @brief MAC PIB union
 *
...
typedef union
{
    ...
    uint8  pad[MAC_MAX_BEACON_PAYLOAD_LEN+2];
} __attribute((__packed__)) MAC_Pib_u;
/**
...
} __attribute((__packed__)) MAC_PanDescr_s;
/**********************/
/**** MLME Request ****/
/**********************/
/**
...
typedef struct
{
    ...
    uint8      pad;
} __attribute((__packed__)) MAC_MlmeReqAssociate_s;
/**
...
typedef struct
{
    ...
    uint8      u8SecurityEnable;    /**< True if security is to be used on command frames */
    uint8      pad[2];
} __attribute((__packed__)) MAC_MlmeReqDisassociate_s;
/**
...
typedef struct
{
    ...
    uint8 pad[2];
} __attribute((__packed__)) MAC_MlmeReqGet_s;
/**
...
typedef struct tagMAC_MlmeReqGts_s
{
    ...
    uint8 u8SecurityEnable;     /**< True if security is to be used on command frames */
    uint8 pad[2];
} __attribute((__packed__)) MAC_MlmeReqGts_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3];
} __attribute((__packed__)) MAC_MlmeReqReset_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeReqRxEnable_s;
/**
...
typedef struct MAC_MlmeReqScan_s
{
    ...
    uint8  pad[2];
} __attribute((__packed__)) MAC_MlmeReqScan_s;
/**
...
} __attribute((__packed__)) MAC_MlmeReqSet_s;
/**
...
typedef struct
{
    ...
    uint8  u8SecurityEnable;    /**< True if security is to be used on command frames */
    uint8 pad[3];
} __attribute((__packed__)) MAC_MlmeReqStart_s;
/**
...
typedef struct
{
    ...
    uint8 pad[2];
} __attribute((__packed__)) MAC_MlmeReqSync_s;
/**
...
typedef struct
{
    ...
    uint8      u8SecurityEnable;    /**< True if security is to be used on command frames */
    uint8 pad[3];
} __attribute((__packed__)) MAC_MlmeReqPoll_s;
/* @} */
/**
...
} __attribute((__packed__)) MAC_MlmeReqVsExtAddr_s;
/* @} */
/**********************/
/**** MLME Confirm ****/
/**********************/
...
} __attribute((__packed__)) MAC_MlmeCfmAssociate_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeCfmDisassociate_s;
/**
...
} __attribute((__packed__)) MAC_MlmeCfmGet_s;
/**
...
typedef struct
{
    ...
    uint8 u8Characteristics;    /**< GTS characteristics */
    uint8 pad[2]; 
} __attribute((__packed__)) MAC_MlmeCfmGts_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeCfmReset_s;
/**
...
typedef struct
{
    uint8 u8Status; /**< Status of receiver enable request @sa MAC_Enum_e */
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeCfmRxEnable_s;
/**
 * @brief Union of results in Scan confirm
 *
 * Either a list of energy detect values or a list of PAN Descriptors (@sa tag MAC_PanDescr_s)
 */
typedef union
{
    uint8          au8EnergyDetect[MAC_MAX_SCAN_CHANNELS];
    MAC_PanDescr_s asPanDescr[MAC_MAX_SCAN_PAN_DESCRS];
} __attribute((__packed__)) MAC_ScanList_u;
/**
...
} __attribute((__packed__)) MAC_MlmeCfmScan_s;
/**
...
typedef struct
{
    ...
    uint8 pad[2]; 
} __attribute((__packed__)) MAC_MlmeCfmSet_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeCfmStart_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeCfmPoll_s;
/* @} */
/**
...
typedef struct
{
    ...
    uint8 pad; 
} __attribute((__packed__)) MAC_MlmeIndAssociate_s;
/**
...
typedef struct
{
    ...
    uint8         u8AclEntry;       /**< Security suite used */
    uint8 pad; 
} __attribute((__packed__)) MAC_MlmeIndDisassociate_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeIndSyncLoss_s;
/**
...
typedef struct
{
    ...
    uint8  u8AclEntry;          /**< Security suite used */
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeIndGts_s;
/**
...
typedef struct
{
    ...
    uint8            pad2[2];
} __attribute((__packed__)) MAC_MlmeIndBeacon_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_MlmeIndCommStatus_s;
/**
...
typedef struct
{
    ...
    uint8         u8AclEntry;       /**< Security suite used */
    uint8 pad[2]; 
} __attribute((__packed__)) MAC_MlmeIndOrphan_s;
/* @} */
/**
...
typedef struct
{
    ...
    uint8         u8SecurityEnable;     /**< True if security is to be used on command frames */
} __attribute((__packed__)) MAC_MlmeRspAssociate_s;
/**
...
typedef struct
{
    ...
    uint8         u8SecurityEnable;     /**< True if security is to be used on command frames */
} __attribute((__packed__)) MAC_MlmeRspOrphan_s;
/* @} */
/*****************************************/
...
} __attribute((__packed__)) MAC_MlmeReqRspType_e;
/**
...
} __attribute((__packed__)) MAC_MlmeReqRspParam_u;
/**
...
} __attribute((__packed__)) MAC_MlmeReqRsp_s;
/**
...
} __attribute((__packed__)) MAC_MlmeSyncCfmStatus_e;
/**
...
} __attribute((__packed__)) MAC_MlmeSyncCfmParam_u;
/**
...
typedef struct
{
    uint8                  u8Status;        /**< Confirm status (@sa MAC_MlmeSyncCfmStatus_e ) */
    uint8                  u8ParamLength;   /**< Parameter length in following union */
    uint16                 u16Pad;          /**< Padding to force alignment */
    MAC_MlmeSyncCfmParam_u uParam;          /**< Union of all possible Confirms */
} __attribute((__packed__)) MAC_MlmeSyncCfm_s;
/* @} */
/****************************************************/
...
typedef enum
{
    ...
    NUM_MAC_MLME_IND
} __attribute((__packed__)) MAC_MlmeDcfmIndType_e;
/**
...
} __attribute((__packed__)) MAC_MlmeDcfmIndParam_u;
/**
...
} __attribute((__packed__)) MAC_MlmeDcfmInd_s;
/* @} */
/**********************/
/**** MCPS Request ****/
/**********************/
...
} __attribute((__packed__)) MAC_TxFrameData_s;
/**
...
} __attribute((__packed__)) MAC_McpsReqData_s;
/**
...
typedef struct
{
    ...
    uint8 pad[3]; 
} __attribute((__packed__)) MAC_McpsReqPurge_s;
/* @} */
/**********************/
/**** MCPS Confirm ****/
/**********************/
...
typedef struct
{
    ...
    uint8 pad[2]; 
} __attribute((__packed__)) MAC_McpsCfmData_s;
/**
...
typedef struct
{
    ...
    uint8 u8Status; /**< Status of request @sa MAC_Enum_e */
    uint8 pad[2]; 
} __attribute((__packed__)) MAC_McpsCfmPurge_s;
/* @} */
/*************************/
/**** MCPS Indication ****/
/*************************/
...
} __attribute((__packed__)) MAC_McpsIndData_s;
/* @} */
/***********************/
/**** MCPS Response ****/
/***********************/
...
} __attribute((__packed__)) MAC_McpsReqRspType_e;
/**
...
} __attribute((__packed__)) MAC_McpsReqRspParam_u;
/**
...
} __attribute((__packed__)) MAC_McpsReqRsp_s;
/**
 * @brief Synchronous confirm status
 *
 * Indicates in the synchronous confirm whether:
...
} __attribute((__packed__)) MAC_McpsSyncCfmStatus_e;
/**
...
} __attribute((__packed__)) MAC_McpsSyncCfmParam_u;
/**
...
} __attribute((__packed__)) MAC_McpsSyncCfm_s;
/* @} */
/****************************************************/
...
typedef enum
{
    ...
    MAC_MCPS_IND_DATA,
    NUM_MAC_MCPS_IND
} __attribute((__packed__)) MAC_McpsDcfmIndType_e;
/**
...
} __attribute((__packed__)) MAC_McpsDcfmIndParam_u;
/**
...
} __attribute((__packed__)) MAC_McpsDcfmInd_s;
/* @} */
/**
...
typedef struct
{
    ...
    uint16 u16Pad;          /**< Padding to force alignment */
} __attribute((__packed__)) MAC_ReqRspHdr_s;
/**
...
typedef struct
{
    ...
    uint8  u8ParamLength;   /**< Parameter length */
    uint16 u16Pad;          /**< Padding to force alignment */
} __attribute((__packed__)) MAC_SyncCfmHdr_s;
/**
...
typedef struct
{
    ...
    uint8  u8ParamLength;   /**< Parameter length */
    uint16 u16Pad;          /**< Padding to force alignment */
} __attribute((__packed__)) MAC_DcfmIndHdr_s;
/* @} */
/**
...
} __attribute((__packed__)) PHY_PibAttr_e;
/**
 * @ingroup grp_phy_sap_pib
...
} __attribute((__packed__)) PHY_Enum_e;
/****************************/
/**** EXPORTED VARIABLES ****/
/****************************/
/****************************/
